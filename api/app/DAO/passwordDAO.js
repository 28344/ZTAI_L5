...
const passwordSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'masa_user', required: true, unique: true },
  password: { type: String, required: true }
}, {
  collection: 'masa_password'
});

const PasswordModel = mongoose.model('masa_password', passwordSchema);
